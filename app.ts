...
let personalmessage: string = "Abdul Salam";
...
let person_name: string = "Abdul Salam";
console.log(person_name .toLowerCase());

let personName: string = "Abdul Salam";
console.log(personName .toUpperCase());

let $perrsonName: string = "Abdul Salam";
...
// Favorite Number
 ...
 let favoritenumber: string= "50333";
...
let  naMes: string[] = ["Qasim","Dawood","Fayaz",];
...
// Greeting
 ...
 let names: string[]= ["Sir Zia Khan," , "Sir Daniyal Nagori,", "Sir Hunain Hyder, ","Sir Ahmad Raza,",];
...
// Your own array
  ...
  let vehichle: string[]= ["Honda Motor cycle ","Honda Civic", "Audi", "BMW ",];
  vehichle.map((items) =>
...
// Guest list
 ...
 let guest_list: string[] = ["Saeed","Nawaz","Riyaz",];
...
// Changing guest list
 ...
 let guest_list2: string[] = ["Saeed","Nawaz","Riyaz",];
...
let guest_list3: string[] = ["Saeed","Nawaz","Riyaz",];
...
let guest_list4: string[] = ["Saeed", "Nawaz", "Riyaz"];
...
// Store a locations in a array.  make sure the array is not in alphabetical order. 
 let places: string[] = ["Makkah  Sharif","Madina Sharif","Lahore","Karachi","Islamabad"];
...
let guest_list5: string[] = ["Saeed", "Nawaz", "Riyaz"];
...
console.log("Equality test:",("Abdul Salam" as string) === "Abdul Salam");

console.log("Inequlity test:",("Abdul Salam" as string !== "Saeed Ahmad"));
...
// // Numerical test involing equality
 ...
 console.log("Inequality test in number:", (22 as number) != 26);
...
// Test whether an item is an a array
 ...
 let fruite: string[] = ["Banana", "Orange", "Mango"];
...
const userName: string []= ["admin","Salam","Saeed","Fayyaz","Qasim"];
...
let userNames: string[]=["admin","Salam","Saeed","Fayyaz","Qasim"];
...
let current_users: string[] = ["salam","saeed","qasiM","NawaZ","dawood"];
let new_users: string[] = ["SALAM","fayz","Qasim","nawaz","riayz"];
...
let oridinalNumber : number[]=[1,2,3,4,5,6,7,8,9];
...
let pizZas:string[]=["pepperoni","chicken","vegitable"];
...
let Magician:string[]=["Hermione Granger","Harry Potter","Ron Weasly","Albus Dubledore"];
...
[key:string]:any,
 ...
 function carinfo(manufacture:string,model:string,optional:Record<string,any>):Car {
  return{
    manufacture,
    model,
    ...optional
 ...
 const myCar:Car = carinfo("Honda","Civic",{color:"Black",year:2024})
 console.log(myCar);
